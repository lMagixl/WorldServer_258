...
void __thiscall
FUN_00414e70(void *this,ushort param_1,undefined2 param_2,undefined4 param_3,undefined4 *param_4)

{
  ...
  if ((iVar12 != 0) || (iVar12 = mysql_store_result(uVar8), iVar12 == 0)) {
    ...
    iVar16 = -1;
    pcVar15 = s_DBCommandInventoryBuyBag___mysql_0044a02c;
...
LAB_004154c1:
  ...
  iVar12 = mysql_query(uVar8,&local_1410);
  if ((iVar12 != 0) || (iVar12 = mysql_store_result(uVar8), iVar12 == 0)) {
    FUN_0040ea30(*(int *)((int)this + 0xc),s_DBCommandInventoryBuyBag___mysql_0044a02c);
    local_1478 = '\x01';
    goto LAB_004154cc;
  }
  puVar6 = (undefined4 *)mysql_fetch_row(iVar12);
  ...
  mysql_free_result(iVar12);
  uVar7 = ((4000U - local_1460) / 100) * 100;
  if (local_1470 < uVar7) {
    local_1478 = '\x03';
    goto LAB_004154cc;
  }
  ...
  local_1478 = '\0';
  wsprintfA(&local_1410,s_UPDATE_UserGameInfo_SET_bag__u_W_00449f9c,(uint)(byte)(cVar1 + 1U),uVar5);
  ...
  if (iVar12 == 0) {
    FUN_0040ea30(*(int *)((int)this + 8),s_DBCommandInventoryBuyBag___mysql_0044a02c);
    local_1478 = '\x01';
    goto LAB_004154cc;
  }
  puVar6 = (undefined4 *)mysql_fetch_row(iVar12);
  ...
  if (cVar2 != '\0') {
    ...
    wsprintfA(&local_1410,s_INSERT_INTO_logcoupon__coupon_id_00449978,local_1468,0x2716,uVar5,
  ...
  wsprintfA(&local_1410,s_INSERT_INTO_LogBuyCashItem__user_00449ef0,uVar5,0x2716,uVar7,local_1470,
...
LAB_004153d0:
  ...
  if (local_1474 != 0) {
    do {
      ...
      wsprintfA(&local_1410,s_INSERT_INTO_pendingpresents__pre_00449e98,uVar8,uVar5);
      iVar12 = mysql_query(*(undefined4 *)((int)this + 8),&local_1410);
      if (iVar12 == 0) {
