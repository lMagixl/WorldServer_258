...
void __thiscall FUN_00425620(void *this,uint param_1,undefined4 param_2,ushort *param_3)

{
  ...
  if ((*(int *)((int)this_00 + 0x1460) == 0) || (*(int *)((int)this_00 + 0x14a4) == 0)) {
    FUN_0041eb20(this,uVar1,0xa1,'\x01',1);
  }
  else if (*(char *)((int)this_00 + 0x1440) == '\x03') {
    FUN_0040b7d0(this_00,(undefined2 *)&param_1,(undefined1 *)&local_4);
    if (1000 < *param_3) {
      FUN_0041eb20(this,uVar1,0xa2,'\x01',1);
      return;
    }
    FUN_00405f30((void *)((param_1 & 0xffff) * 0x3c0 + *(int *)((int)this + 0xe4)),(byte)local_4,
