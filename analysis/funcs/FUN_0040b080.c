...
int __thiscall
FUN_0040b080(void *this,char param_1,ushort param_2,undefined4 *param_3,uint *param_4,uint *param_5)

{
  ...
  if (param_1 == '\x01') {
    ...
    *param_3 = uVar2;
    ...
    iVar3 = CONCAT31((int3)(uVar4 >> 8),0x16);
  }
  else {
LAB_0040b131:
    uVar8 = (uVar6 * 8000) / 100;
    *param_5 = uVar8;
    iVar3 = CONCAT31((int3)((ulonglong)(uVar6 * 8000) * 0x51eb851f >> 8),3);
    if (*(byte *)((int)this + 0x1540) < 3) {
      uVar5 = (uint3)(*(uint *)((int)this + 0x153c) >> 8);
      if (((8000 - uVar8) / 100) * 100 <= *(uint *)((int)this + 0x153c)) {
