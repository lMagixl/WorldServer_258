...
void __thiscall FUN_00420cb0(void *this,ushort param_1,undefined4 param_2,ushort *param_3)

{
  char cVar1;
  ushort uVar2;
  void *this_00;
  undefined2 local_100c [3];
  ...
  if ((*(int *)((int)this_00 + 0x1460) == 0) || (*(int *)((int)this_00 + 0x14a4) == 0)) {
    FUN_0041eb20(this,param_1,0x30,'\x01',1);
  ...
  if (*(char *)((int)this_00 + 0x1440) == '\x03') {
    ...
    if (uVar2 < DAT_00456030) {
      ...
      FUN_0041eb20(this,param_1,0x31,'\x01',1);
    }
  }
  FUN_00435e83(local_4);
  return;
