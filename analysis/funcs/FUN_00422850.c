...
void __thiscall FUN_00422850(void *this,ushort param_1,undefined4 param_2,char *param_3)

{
  ...
  if ((*(int *)(*(int *)((int)this + 0xd4) + 0x1460 + iVar5) != 0) &&
     (*(int *)((int)this + 0xd4) + 0x14a4 + *(int *)((int)this_00 + 0x14a4)) != 0)) {
    if (*(char *)((int)this_00 + 0x1440) != '\x02') {
      FUN_0041eb20(this,param_1,0x42,'\x01',1);
    ...
    iVar3 = FUN_0040b1a0(this_00,cVar1,uVar4,&local_1010,&local_100c,&local_1014);
    if ((char)iVar3 == '\0') {
      iVar3 = *(int *)((int)this + 0xd4);
      local_ffc = *(undefined1 *)(iVar3 + 0x1541 + iVar5);
  ...
  FUN_0041eb20(this,param_1,0x41,'\x01',1);
  FUN_00435e83(local_4);
  return;
}
